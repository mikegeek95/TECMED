...
$pdf->Ln();
$pdf->Cell(33,5,"PAQUETERIA: ".strtoupper(substr($paqueteria[$result_guias_row['paqueteria']],0,4)),0,0);
$pdf->Cell(30,5,"EST. PAGO: ".strtoupper(substr($est_pago[$result_guias_row['est_pago']],0,3)),0,0);
$pdf->Cell(33,5,"EST. RECIBO: ".strtoupper(substr($est_recibido[$result_guias_row['est_recibido']],0,3)),0,0);
//$pdf->Ln();

if($result_guias_row['est_recibido'] == 3){
	$pdf->Cell(55,5,"F. RECIBIDO: ".strtoupper($result_guias_row['f_recibido']),0,0);
	$pdf->Cell(40,5,"RECIBIO: ".strtoupper(utf8_encode($result_guias_row['recibio'])),0,0);
	$pdf->Ln();
}
...
if($result_guias_row['facturado'] == 1){
	$pdf->Cell(50,7,"NO. FACTURA: ".strtoupper($result_guias_row['no_factura']),0,0);
	//$pdf->Ln();
}
...
$pdf->Ln();
	...
	$pdf->Cell(35,5,"FECHA PAGO",1,0,'C');
	$pdf->Cell(35,5,"MONTO",1,0,'C');
	$pdf->Cell(30,5,"MONEDA",1,0,'C');
	$pdf->Cell(40,5,"METODO",1,0,'C');
