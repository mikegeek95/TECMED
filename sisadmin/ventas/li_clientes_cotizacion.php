...
<tr>
  ...
  <?php
	...
	<tr>
			...
			?>
            <td align="center" ><input type="button" name="button" id="button" value="Seleccionar" onClick="S_cliente_cotizacion('<?php echo $id;?>','<?php echo $nombre;?>','<?php echo $nivel;?>','<?php echo $idniveles; ?>'); $('#ModalSecundaria').css('display','none'); $('#contenido_modal_dos').html('');"></td>
      </tr>
