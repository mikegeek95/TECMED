...
<tr>
            ...
            <td align="center" ><input type="button" name="button" id="button" value="Seleccionar" onClick="S_cliente('0','Publico General','0','0'); CerrarModalGeneral('ModalPrincipal');"></td>
      </tr>
  ...
  <?php
	...
	<tr>
			...
			?>
            <td align="center" ><input type="button" name="button" id="button" value="Seleccionar" onClick="S_cliente('<?php echo $id;?>','<?php echo $nombre;?>','<?php echo $nivel;?>','<?php echo $idniveles; ?>'); CerrarModalGeneral('ModalPrincipal');"></td>
      </tr>
