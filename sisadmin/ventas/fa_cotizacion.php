  ...
  <header>
    ...
    <div class="module_content">
       ...
       <fieldset  > 
          ...
          <input name="v_nombre_cliente" type="text" id="v_nombre_cliente" placeholder="Jose Luis Gomez Aguiar" style="width:90%;" title="Campo Nombre de la Categor&iacute;a" onkeypress="bloquearMas(event.keyCode);" value="Venta General" readonly />
  ...
  <header>
   ...
   <div class="module_content" >    
            ...
            <div id="d_productos_shoping" >
             <?php 
                $carrito->verCarritoCotizacion('0');
             ?>
            </div>
    ...
    <footer>
        ...
        <div class="submit_link">
            ...
            <input type="button" value="Generar Cotizaci&oacute;n" class="alt_btn" onclick="G_Cotizacion();" style=" background-repeat:repeat">
        </div>
    </footer>        
</article>
