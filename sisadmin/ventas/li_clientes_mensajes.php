...
<div class="alert alert-success" id="msj-add" style="display: none;" role="alert">
	...
	<table  border="0" cellspacing="2" cellpadding="2" class="table table-bordered"  id="d_clientes" style="color:#999" >
		...
		<tbody>
			<tr>
				<td align="center" >-</td>
				<td >TODOS</td>
				<td align="center" ><input type="button" name="button" id="button" value="Seleccionar" onClick="guardar_cliente_mensaje('0','TODOS');"></td>
	  		</tr>
			...
			<tr>
				...
				?>
				<td align="center">
					<input type="button" name="button" id="button" value="Seleccionar" onClick="guardar_cliente_mensaje('<?php echo $id;?>','<?php echo $nombre;?>');">
				</td>
	  		</tr>
			<?php
			}
