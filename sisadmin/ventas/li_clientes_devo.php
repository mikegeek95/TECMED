...
<tr>
            ...
            <td align="center" ><input type="button" name="button" id="button" value="Seleccionar" onClick="S_cliente_devo('0','Publico General','0','0');"></td>
      </tr>
  ...
  <?php
	...
	<tr>
			...
			?>
            <td align="center" ><input type="button" name="button" id="button" value="Seleccionar" onClick="S_cliente_devo('<?php echo $id;?>','<?php echo $nombre;?>','<?php echo $nivel;?>','<?php echo $idniveles; ?>'); $('#ModalPrincipal').css('display','none'); $('#contenido_modal').html('');"></td>
      </tr>
