...
<table  border="0" cellspacing="2" cellpadding="2"  id="d_clientes" style="color:#999" class="table table-bordered" >
<thead > 
  <tr >
...
<tr>
  ...
  <?php
	...
	<tr>
			...
			?>
            <td align="center" ><input type="button" name="button" id="button" value="Seleccionar" onClick="S_cliente_apartado('<?php echo $id;?>','<?php echo $nombre;?>','<?php echo $nivel;?>','<?php echo $idniveles; ?>'); $('#ModalSecundaria').css('display','none'); $('#contenido_modal_dos').html('');"></td>
      </tr>
