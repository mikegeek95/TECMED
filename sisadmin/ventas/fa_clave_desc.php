...
<div style="margin:auto; font-size:14px; padding:5px; color:#000;">
	...
	<p>Para poder introducir descuento directo a la venta, introduzca la clave de confirmaci&oacute;n</p>
    <span style="color:#F00; margin-right: 5px;">*Introducir Clave</span>
    <input type="password" id="v_clave" name="v_clave" onkeypress="if (event.keyCode==13){validar_clave_desc();}" />
