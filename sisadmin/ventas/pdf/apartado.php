...
$pdf->SetFontSize(9);
//$pdf->Ln();
$pdf->Cell(100,5,utf8_decode("NO. APARTADO : ").$ventas->idapartados);
$pdf->Cell(40,5,utf8_decode("FECHA: ").$datos['fecha']);
$pdf->Ln();
...
$pdf->Cell(100,7,"F. FIN: ".strtoupper($fecha_fin),0,0);
...
$pdf->Ln();
	$pdf->SetFontSize(9);
	$pdf->SetX(10);
	$pdf->Cell(34,7,"CLAVE",1,0,'C');
	$pdf->Cell(29,7,"CAT",1,0,'C');
	$pdf->Cell(100,7,"PRODUCTO",1,0,'C');
	$pdf->Cell(12,7,"CANT.",1,0,'C');
	$pdf->Cell(22,7,"PRECIO",1,0,'C');
...
foreach($productos as $p )
    {
				...
				$pdf->SetX(10);
					$pdf->SetFontSize(9);
					$pdf->Cell(34,5,$p->idproducto,1,0,'C');
					$pdf->Cell(29,5," ".strtoupper($cat),1,0,'L');
					$pdf->Cell(100,5," ".strtoupper($p->nombre." #".$p->talla),1,0,'L');
					$pdf->Cell(12,5,$p->cantidad,1,0,'C');
					$pdf->Cell(22,5,"$ ".number_format($p->pv,2,'.',','),1,0,'C');
...
/*$pdf->SetX(20);					
	...
	$pdf->SetX(20);					
					...
					$pdf->Cell(30,5," ",0,0,'C');		
					$pdf->Cell(10,5," ",0,0,'C');			
					$pdf->Cell(20,5,"ABONO $ ".number_format($datos['abono'],2,'.',','),0,0,'R');
					$pdf->Ln();
	}
	...
	$pdf->SetX(20);				
					...
					$pdf->Cell(30,5," ",0,0,'C');		
					$pdf->Cell(10,5," ",0,0,'C');			
					$pdf->Cell(20,5,"TOTAL SIN DESCUENTO $".number_format($total,2,'.',','),0,0,'R');
					$pdf->Ln();
